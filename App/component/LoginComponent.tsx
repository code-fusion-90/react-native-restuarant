...
class LoginTab extends Component<any, any> {
...
class RegisterTab extends Component<any, any> {
    ...
    getImageFromCamera = async () => {
        ...
        if (status === 'granted' ) {
            ...
            Alert.alert(
                'Camera Permission',
                'Camera Needed.'+JSON.stringify(permissions),
                [
    ...
    processImage = async (imageUri: any) => {
